		...
		switch (j->jointype)
		{
			...
			case JOIN_FULL:
				...
				*inner_join_rels = bms_union(left_inners, right_inners);
				...
				break;
//				8.4-9.0-MERGE-FIX-ME: Do we still need to handle JOIN_RIGHT
//			case JOIN_RIGHT:
								 ...
								 List **postponed_qual_list)
{
	...
	{
		Node   *qual = (Node *) lfirst(l);
		//8.4-9.0-MERGE-FIX-ME: What should be pass to distribute_qual_to_rels
		// for deduced_nullable_relids and postponed_qual_list
