				 ...
				 PlannerConfig *config)
{
	...
	if (parse->hasSubLinks)
		...
		// 8.4-9.0-MERGE-FIX-ME: Should we retain anything from cdbsubselect_flatten_sublinks
		...
		case T_HashJoin:
			 ...
			 */
			{
				switch (((Join *) node)->jointype)
				{
					...
					case JOIN_SEMI: //8.4-9.0-MERGE-FIX-ME, can we replace JOIN_IN with JOIN_SEMI and what about JOIN_ANTI?
