...
//8.4-9.0-MERGE-FIX-ME: Signature of get_first_col_type is different
// as compared to commit: e006a24a. But keeping it as is for now.
/*
...
simplify_EXISTS_query(Query *query)
{
	...
	//8.4-9.0-MERGE-FIX-ME: hasDistinctOn was introduced in commit: 951130475221562b44b0da575fac8470adb5b555
	// Port it from there first
