...
// 8.4-9.0-MERGE-FIX-ME: convert_IN_to_join has been removed in commit: e006a24a
...
extern Node *convert_NOT_EXISTS_to_antijoin(PlannerInfo *root,
											List **rtrlist_inout, SubLink *sublink);
